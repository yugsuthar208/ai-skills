...
### 1. [yug/ai-skills](https://github.com/yug/ai-skills)
...
如果您想快速提高生产力,请安装 [Agentic Awesome Skills](https://github.com/yug/ai-skills) 并从 [`claude-code-skills.md`](claude-code-skills.md) 和 [`bundles.md`](bundles.md) 开始。
