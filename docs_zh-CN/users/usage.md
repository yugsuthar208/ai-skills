...
1. 尝试重启你的 IDE/CLI
2. 检查安装路径是否与你的工具匹配
3. 尝试显式路径：`npx ai-skills --claude`（或 `--cursor`、`--gemini` 等）
...
2. 阅读描述以确保你正确使用它
3. [打开问题](https://github.com/yug/ai-skills/issues)并提供详细信息
...
3. [打开讨论](https://github.com/yug/ai-skills/discussions)
4. [提交问题](https://github.com/yug/ai-skills/issues)以帮助我们改进此指南！
