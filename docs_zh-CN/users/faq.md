...
如果你从 npm 收到 404，请使用：`npx github:yug/ai-skills`
...
如果你在已删除的符号链接解决方法周围创建了较旧的克隆，请重新安装到新目录或重新运行 `npx ai-skills`。
...
- 根据 [issue #274](https://github.com/yug/ai-skills/issues/274) 改编的可选批处理脚本
...
请[打开问题](https://github.com/yug/ai-skills/issues)！包括：
...
**仍然困惑？**[打开讨论](https://github.com/yug/ai-skills/discussions)，我们会帮助你！🙌
