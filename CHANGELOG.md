...
- AAS Core setup: configure the exact `aas` runtime with the [Core guide](https://github.com/yug/ai-skills/blob/main/docs/users/aas-core.md)
- Direct skill distribution: `npx ai-skills`
- [Choose your tool](https://github.com/yug/ai-skills#choose-your-tool)
- [Best skills by tool](https://github.com/yug/ai-skills#best-skills-by-tool)
- [Bundles](https://github.com/yug/ai-skills/blob/main/docs/users/bundles.md)
- [Workflows](https://github.com/yug/ai-skills/blob/main/docs/users/workflows.md)
...
- **[sudosubin/gh-attach](https://github.com/sudosubin/gh-attach)** for `gh-attach` in [PR #1060](https://github.com/yug/ai-skills/pull/1060).
- **[happy520ai/unified-ai-system](https://github.com/happy520ai/unified-ai-system)** for `unified-ai-gateway` in [PR #1061](https://github.com/yug/ai-skills/pull/1061).
- **[OJPalenzuela/agents-generator](https://github.com/OJPalenzuela/agents-generator)** for `agents-generator` in [PR #1067](https://github.com/yug/ai-skills/pull/1067), which closes issue #1065.
- **[talivia-group/agent](https://github.com/talivia-group/agent)** for `talivia-agent-kit` in [PR #1069](https://github.com/yug/ai-skills/pull/1069).
...
- **[@Phelan164](https://github.com/Phelan164)** and **[Phelan164/codex-howto](https://github.com/Phelan164/codex-howto)** for `maintain-codex-wiki` in [PR #1052](https://github.com/yug/ai-skills/pull/1052).
- **[@merc1305](https://github.com/merc1305)** and **[merc1305/findMate](https://github.com/merc1305/findMate)** for the `find-complementary-founders` improvements in [PR #1011](https://github.com/yug/ai-skills/pull/1011).
- **[@abhinaykrupa](https://github.com/abhinaykrupa)** and **[abhinaykrupa/cowork-to-code-bridge](https://github.com/abhinaykrupa/cowork-to-code-bridge)** for `cowork-to-code-bridge` in [PR #1046](https://github.com/yug/ai-skills/pull/1046).
- **[@ASI2030](https://github.com/ASI2030)** and **[ASI2030/Fact-Check-X](https://github.com/ASI2030/Fact-Check-X)** for `fact-check-x-complete` in [PR #1049](https://github.com/yug/ai-skills/pull/1049).
...
- **[@shouryamaanjain](https://github.com/shouryamaanjain)** and **[cohesivity-org/cohesivity-skill](https://github.com/cohesivity-org/cohesivity-skill)** for `cohesivity` in [PR #1032](https://github.com/yug/ai-skills/pull/1032).
- **[@alen-hh](https://github.com/alen-hh)** for the Modellix source URL and speech-default refresh in [PR #1025](https://github.com/yug/ai-skills/pull/1025).
...
- **[@browseract-skill](https://github.com/browseract-skill)** and **[browser-act/skills](https://github.com/browser-act/skills)** for `browser-act` in [PR #1019](https://github.com/yug/ai-skills/pull/1019).
- **[@thecsdoctor](https://github.com/thecsdoctor)** and **[thecsdoctor/brendangregg-use-tsa-skill](https://github.com/thecsdoctor/brendangregg-use-tsa-skill)** for `brendangregg-use-tsa` in [PR #1012](https://github.com/yug/ai-skills/pull/1012).
- **[@alen-hh](https://github.com/alen-hh)** for the verified Modellix upstream rename in [PR #1009](https://github.com/yug/ai-skills/pull/1009).
- **[@kriptoburak](https://github.com/kriptoburak)** for the Xquik X Actors documentation in [PR #1002](https://github.com/yug/ai-skills/pull/1002).
...
- Fixed AAS MCP initialization for newer clients such as Claude Code 2.1.x by negotiating the server-supported protocol revision instead of rejecting every request that advertises a different revision ([#1003](https://github.com/yug/ai-skills/issues/1003)).
...
- **[@rk2kaler](https://github.com/rk2kaler)** for reporting the protocol negotiation regression with a complete reproduction in [issue #1003](https://github.com/yug/ai-skills/issues/1003).
...
- **[@provencher](https://github.com/provencher)** and **[provencher/codex-skills](https://github.com/provencher/codex-skills)** for the upstream `orchestrate` skill integrated in [PR #989](https://github.com/yug/ai-skills/pull/989).
- **[@merc1305](https://github.com/merc1305)** and **[merc1305/findMate](https://github.com/merc1305/findMate)** for `find-complementary-founders` in [PR #992](https://github.com/yug/ai-skills/pull/992).
- **[@maleksaadi0109](https://github.com/maleksaadi0109)** and **[maleksaadi0109/hyprfedora](https://github.com/maleksaadi0109/hyprfedora)** for `fedora-hyprland-installer` in [PR #994](https://github.com/yug/ai-skills/pull/994).
- **Samuel Bushi** and **UIZZE** for the expanded `uizze-ui-research` workflow finalized in [PR #988](https://github.com/yug/ai-skills/pull/988).
...
- **[@ununununium](https://github.com/ununununium)** and **[nowork-studio/NotFair](https://github.com/nowork-studio/NotFair)** for the official `seo-drift` contribution in [PR #974](https://github.com/yug/ai-skills/pull/974).
...
- **[@SpecializedBaby](https://github.com/SpecializedBaby)** for reporting the native Windows Codex ACL preview failure in [discussion #956](https://github.com/yug/ai-skills/discussions/956).
...
- Hosted catalog: https://yug.github.io/ai-skills/
...
- **release-pinned installs** - default `npx ai-skills` installs now clone the matching package release tag instead of the repository tip, reducing drift between npm package contents and installed skills.
...
> **Patch release to restore `npx ai-skills` installs after the published CLI started failing to resolve `yaml` at runtime**
...
- Install: `npx ai-skills`
- Plugin explainer: [docs/users/plugins.md](https://github.com/yug/ai-skills/blob/main/docs/users/plugins.md)
- Choose your tool: [README -> Choose Your Tool](https://github.com/yug/ai-skills#choose-your-tool)
- Bundles: [docs/users/bundles.md](https://github.com/yug/ai-skills/blob/main/docs/users/bundles.md)
- Workflows: [docs/users/workflows.md](https://github.com/yug/ai-skills/blob/main/docs/users/workflows.md)
...
- **Codex plugin distribution** - formalized the root Codex plugin metadata in `.agents/plugins/marketplace.json` and `plugins/ai-skills/.codex-plugin/plugin.json`, alongside generated bundle plugins.
...
> **Patch release to fix the published npm CLI bundle so `npx ai-skills` resolves its runtime helper modules correctly**

This release fixes a packaging regression in the published npm artifact. Version `7.9.1` shipped `tools/bin/install.js` without the required `tools/lib` runtime helpers, causing `npx ai-skills` to fail with `MODULE_NOT_FOUND` for `../lib/symlink-safety`.
...
- [@yug](https://github.com/yug) - 54 commits
...
- **Multi-Tool Install Support**: The installer now supports installing skills for multiple tools simultaneously (e.g., `npx ai-skills --claude --codex`). Fixes #182.
...
- **[@yug](https://github.com/yug)** - Podcast Generation & Azure skills sync (PR #74).
...
- [@yug](https://github.com/yug) - Workflows architecture, docs, and release integration
...
- **Documentation**: Clarified in README.md and GETTING_STARTED.md that installation means cloning the full repo once; Starter Packs are curated lists to discover skills by role, not a different installation method (fixes [#44](https://github.com/yug/ai-skills/issues/44)).
...
- [@yug](https://github.com/yug) - Voice AI Engine (PR #33)
...
- [@yug](https://github.com/yug) - PR #23
