...
This app is the static catalog and skill browser for `ai-skills`. It ships the generated registry, renders searchable skill detail pages, and publishes the public site to GitHub Pages.
