...
**[Read the AAS Core preview guide →](https://github.com/yug/ai-skills/blob/v15.8.0/docs/users/aas-core.md)**
...
[![GitHub stars](https://img.shields.io/badge/⭐%2044%2C000%2B%20Stars-gold?style=for-the-badge)](https://github.com/yug/ai-skills/stargazers)
...
[![Latest Release](https://img.shields.io/github/v/release/yug/ai-skills?display_name=tag&style=for-the-badge)](https://github.com/yug/ai-skills/releases/latest)
...
[![Antigravity](https://img.shields.io/badge/Antigravity-AI%20IDE-red?style=for-the-badge)](https://github.com/yug/ai-skills)
...
Read the [AAS Core guide](https://github.com/yug/ai-skills/blob/v15.8.0/docs/users/aas-core.md) for the exact trust boundaries, current preview status, Codex/Claude setup model, and CLI lifecycle.
...
- **Inspect before installing**: the hosted [Skill Workbench](https://yug.github.io/ai-skills/workbench) reviews agent-produced stack manifests and immutable plans without browser-side installation.
...
npx ai-skills --antigravity --skills brainstorming,systematic-debugging --dry-run
...
`npx ai-skills` command uses the same protected Antigravity target.
...
```bash
npx ai-skills audit --skills brainstorming,backend-dev-guidelines
npx ai-skills --skills brainstorming,backend-dev-guidelines --dry-run
```
...
```bash
gh skill preview yug/ai-skills skills/brainstorming/SKILL.md
gh skill install yug/ai-skills skills/brainstorming/SKILL.md \
...
- Compare the hosted [specialized plugin landing page](https://yug.github.io/ai-skills/plugins).
...
| Cursor         | `npx ai-skills --cursor`                              | `@brainstorming help me plan a feature`              |
| Gemini CLI     | `npx ai-skills --gemini`                              | `Use brainstorming to plan a feature`                |
| Codex CLI      | [AAS Core local MCP preview](docs/users/codex-cli-skills.md) or `npx ai-skills --codex` | Ask Codex to choose and compose an AAS stack |
| Autohand Code  | `npx ai-skills --path ~/.autohand/skills` or `--path .autohand/skills` | `Use brainstorming to plan a feature`                |
| Antigravity IDE | `npx ai-skills --antigravity --skills <ids> --dry-run` | Ask an MCP-enabled agent to choose exact IDs first |
| Antigravity CLI (`agy`) | `npx ai-skills --agy`                        | `/brainstorming help me plan a feature`              |
| Kiro CLI       | `npx ai-skills --kiro`                                | `Use brainstorming to plan a feature`                |
| Kiro IDE       | `npx ai-skills --path ~/.kiro/skills`                 | `Use @brainstorming to plan a feature`               |
| GitHub Copilot | `gh skill install yug/ai-skills skills/brainstorming/SKILL.md --agent github-copilot --scope user --pin v14.2.0` (preview) | `Ask Copilot to use brainstorming to plan a feature` |
| OpenCode       | `npx ai-skills --path .agents/skills --category development,backend --risk safe,none` | `opencode run @brainstorming help me plan a feature` |
| AdaL CLI       | `npx ai-skills --path .adal/skills`                   | `Use brainstorming to plan a feature`                |
| Custom path    | `npx ai-skills --path ./my-skills`                    | Depends on your tool                                   |
...
For AAS Core, follow the [preview guide](https://github.com/yug/ai-skills/blob/v15.8.0/docs/users/aas-core.md) and use only a package release whose notes explicitly state that it includes Core. Release 14.6.0 predates Core; Core-capable releases begin with the 15.x line.
...
```bash
npx ai-skills --path ~/.autohand/skills
npx ai-skills --path .autohand/skills
```
...
```bash
npx ai-skills@14.3.0 --codex --release 14.3.0 --skills frontend-design,game-development/2d-games --dry-run
```
...
The hosted [Skill Workbench](https://yug.github.io/ai-skills/workbench) imports and reviews AAS Core stack manifests and immutable plans in browser memory. It does not access the filesystem, generate an approved plan, or install skills.
...
- **Hosted and local web app** in [`apps/web-app`](apps/web-app) and on [GitHub Pages](https://yug.github.io/ai-skills/)
...
- Browse the hosted catalog at [https://yug.github.io/ai-skills/](https://yug.github.io/ai-skills/).
...
- **[Agentic Awesome Skills vs Awesome Claude Skills](docs/users/ai-skills-vs-awesome-claude-skills.md)** for breadth vs curated-list tradeoffs.
...
- For Core setup, trust boundaries, stack manifests, and preview status, use the [AAS Core guide](https://github.com/yug/ai-skills/blob/v15.8.0/docs/users/aas-core.md).
...
- If you integrate ai-skills into a host, read the discovery contract first: [Stable Skills Manifest v1](docs/users/discovery-manifest.md).
...
- For OpenCode or other `.agents/skills` installs, prefer a reduced install such as `npx ai-skills --path .agents/skills --category development,backend --risk safe,none`.
...
[![Buy me a coffee](assets/buy-me-a-coffee-banner.png)](https://buymeacoffee.com/yug)

- [Buy me a book on Buy Me a Coffee](https://buymeacoffee.com/yug)
...
- [Discussions](https://github.com/yug/ai-skills/discussions) for questions, ideas, showcase posts, and community feedback.
- [Issues](https://github.com/yug/ai-skills/issues) for reproducible bugs and concrete, actionable improvement requests.
- [Follow @AASkills_ on X](https://x.com/AASkills_) for daily skills, practical workflows, and example prompts from the repo.
- [Follow @yug on X](https://x.com/yug) for project updates and releases.
...
<a href="https://github.com/yug/ai-skills/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=yug/ai-skills&max=500" alt="Repository contributors" />
</a>

Made with [contrib.rocks](https://contrib.rocks). *(Image may be cached; [view live contributors](https://github.com/yug/ai-skills/graphs/contributors) on GitHub.)*
