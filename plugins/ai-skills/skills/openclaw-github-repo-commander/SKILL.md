...
Originally contributed by [@wd041216-bit](https://github.com/wd041216-bit) in [PR #340](https://github.com/yug/ai-skills/pull/340). No standalone upstream repository is currently available for this skill.
