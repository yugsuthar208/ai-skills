...
description: "Use ai-skills with Jetski/Cortex without hitting context-window overflow with 2,001+ skills."
---
...
This guide shows how to integrate the `ai-skills` repository with an agent based on **Jetski/Cortex + Gemini** (or similar frameworks) **without exceeding the model context window**.
...
Following this pattern, Jetski/Cortex + Gemini can use the full `ai-skills` library safely, at scale, and within modern model context-window limits.
