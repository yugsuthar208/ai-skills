...
This example shows one way to integrate **ai-skills** with a Jetski/Cortex‑style agent using **lazy loading** based on `@skill-id` mentions, instead of concatenating every `SKILL.md` into the prompt.
...
const REPO_ROOT = "/path/to/ai-skills";
