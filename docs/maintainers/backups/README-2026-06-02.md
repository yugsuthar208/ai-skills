...
**Start here:** [Star the repo](https://github.com/yug/antigravity-awesome-skills/stargazers) · [Install in 1 minute](#installation) · [Choose your tool](#choose-your-tool) · [Best skills by tool](#best-skills-by-tool) · [📚 Browse 1,494+ Skills](#browse-1494-skills) · [Bundles](docs/users/bundles.md) · [Workflows](docs/users/workflows.md) · [Plugins for Claude Code and Codex](docs/users/plugins.md)

[![GitHub stars](https://img.shields.io/badge/⭐%2039%2C000%2B%20Stars-gold?style=for-the-badge)](https://github.com/yug/antigravity-awesome-skills/stargazers)
...
[![Latest Release](https://img.shields.io/github/v/release/yug/antigravity-awesome-skills?display_name=tag&style=for-the-badge)](https://github.com/yug/antigravity-awesome-skills/releases/latest)
...
[![Antigravity](https://img.shields.io/badge/Antigravity-AI%20IDE-red?style=for-the-badge)](https://github.com/yug/antigravity-awesome-skills)
...
Start with [Bundles](docs/users/bundles.md) for role-based recommendations, [Workflows](docs/users/workflows.md) for ordered execution playbooks, [CATALOG.md](CATALOG.md) for the full registry, and the hosted [GitHub Pages catalog](https://yug.github.io/antigravity-awesome-skills/) when you want a browsable web UI.
...
- **Hosted and local web app** in [`apps/web-app`](apps/web-app) and on [GitHub Pages](https://yug.github.io/antigravity-awesome-skills/)
...
- Browse the hosted catalog at [https://yug.github.io/antigravity-awesome-skills/](https://yug.github.io/antigravity-awesome-skills/).
...
- [Discussions](https://github.com/yug/antigravity-awesome-skills/discussions) for questions, ideas, showcase posts, and community feedback.
- [Issues](https://github.com/yug/antigravity-awesome-skills/issues) for reproducible bugs and concrete, actionable improvement requests.
...
<a href="https://github.com/yug/antigravity-awesome-skills/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=yug/antigravity-awesome-skills" alt="Repository contributors" />
</a>

Made with [contrib.rocks](https://contrib.rocks). *(Image may be cached; [view live contributors](https://github.com/yug/antigravity-awesome-skills/graphs/contributors) on GitHub.)*
...
<a href="https://www.star-history.com/#yug/antigravity-awesome-skills&type=date&legend=top-left">
 <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=yug/antigravity-awesome-skills&type=date&legend=top-left" />
</a>

<a href="https://www.star-history.com/yug/antigravity-awesome-skills">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=yug/antigravity-awesome-skills&style=landscape1&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=yug/antigravity-awesome-skills&style=landscape1" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=yug/antigravity-awesome-skills&style=landscape1" />
 </picture>
</a>
