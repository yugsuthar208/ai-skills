...
When you ran `npx ai-skills` or cloned the repository, you:
...
3. Try the explicit path: `npx ai-skills --claude` (or `--cursor`, `--gemini`, etc.)
...
3. [Open an issue](https://github.com/yug/ai-skills/issues) with details
...
3. [Open a Discussion](https://github.com/yug/ai-skills/discussions)
4. [File an Issue](https://github.com/yug/ai-skills/issues) to help us improve this guide!
