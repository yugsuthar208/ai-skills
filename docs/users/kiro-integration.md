...
git clone https://github.com/yug/ai-skills.git ~/.kiro/skills
```
...
- **Issues**: [GitHub Issues](https://github.com/yug/ai-skills/issues)
- **Discussions**: [GitHub Discussions](https://github.com/yug/ai-skills/discussions)
