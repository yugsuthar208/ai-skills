...
const REPO = "https://github.com/yug/ai-skills.git";
...
Examples:
  npx ai-skills --skills brainstorming --dry-run
  npx ai-skills audit --skills brainstorming
  npx ai-skills --cursor --risk safe,none
  npx ai-skills --all --dry-run
  npx ai-skills --kiro --skills brainstorming
  npx ai-skills --antigravity --skills brainstorming --dry-run
  npx ai-skills --antigravity --risk safe,none
  npx ai-skills --agy --skills brainstorming
  npx ai-skills --path .agents/skills --category development,backend --risk safe,none
  npx ai-skills --path .agents/skills --tags debugging,typescript-legacy-
  npx ai-skills --codex --skills frontend-design,game-development/2d-games --dry-run
  npx ai-skills --release 4.6.0 --skills brainstorming
  npx ai-skills --path ./my-skills --skills brainstorming
  npx ai-skills --claude --codex --skills brainstorming
`);
}
...
function buildAntigravitySelectionMessage() {
  return [
    ...
    "",
    "  npx ai-skills --antigravity --skills skill-id-1,skill-id-2 --dry-run",
    "",
    "Copyable agent prompt:",
    "  Inspect this project and use the AAS MCP to search the complete catalog and choose the exact relevant skill IDs. Replace the example IDs and run npx ai-skills --antigravity --skills skill-id-1,skill-id-2 --dry-run. Show me the plan and do not install the complete catalog.",
    "",
    ...
    "",
    "AAS Core setup: https://github.com/yug/ai-skills/blob/main/docs/users/aas-core.md",
    "",
    "If you intentionally accept the Antigravity context and crash-loop risk, use:",
    "  npx ai-skills --antigravity --all",
    "",
    "Recovery: https://github.com/yug/ai-skills/blob/main/docs/users/windows-truncation-recovery.md",
  ].join("\n");
}
...
function getPostInstallMessages(targets, selectors = buildInstallSelectors({})) {
  ...
  if (targets.some((target) => isOpenCodeStylePath(target.path))) {
    ...
    if (!hasInstallSelectors(selectors)) {
      messages.push(
        "Example: npx ai-skills --path .agents/skills --category development,backend --risk safe,none",
      );
    }
  }
